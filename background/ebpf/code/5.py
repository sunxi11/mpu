...
def get_cycles():
    ...
    for i in str_1:
        if i!='' and i[0]>='0' and i[0]<='9':
            num.append(int(i))
    outputfn=f'cycles/exp-cycles-5.log'
...
if __name__ == '__main__':
    ...
    custom_cflags.append(f"-D_HASHFN_N={HASHFN_N}")
    ...
    # load BPF program
    b = BPF(src_file=f'{sys.path[0]}/ebpf/new/bloomfilter/univmon.h', cflags=custom_cflags, device=None)
