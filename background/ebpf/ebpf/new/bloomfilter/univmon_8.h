...
BPF_PERCPU_ARRAY(countsketch51, __u32, 26042);
BPF_PERCPU_ARRAY(countsketch52, __u32, 26042);
BPF_PERCPU_ARRAY(countsketch61, __u32, 26042);
BPF_PERCPU_ARRAY(countsketch62, __u32, 26042);
BPF_PERCPU_ARRAY(countsketch71, __u32, 26042);
BPF_PERCPU_ARRAY(countsketch72, __u32, 26042);
BPF_PERCPU_ARRAY(countsketch81, __u32, 26042);
BPF_PERCPU_ARRAY(countsketch82, __u32, 26042);
