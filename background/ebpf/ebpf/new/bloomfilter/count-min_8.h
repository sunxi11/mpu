...
BPF_ARRAY(countmin71, __u32, 327680);
BPF_ARRAY(countmin72, __u32, 327680);
BPF_ARRAY(countmin73, __u32, 327680);
BPF_ARRAY(countmin74, __u32, 327680);
BPF_ARRAY(countmin75, __u32, 327680);
BPF_ARRAY(countmin76, __u32, 327680);
BPF_ARRAY(countmin77, __u32, 327680);
BPF_ARRAY(countmin78, __u32, 327680);

BPF_ARRAY(countmin81, __u32, 327680);
BPF_ARRAY(countmin82, __u32, 327680);
BPF_ARRAY(countmin83, __u32, 327680);
BPF_ARRAY(countmin84, __u32, 327680);
BPF_ARRAY(countmin85, __u32, 327680);
BPF_ARRAY(countmin86, __u32, 327680);
BPF_ARRAY(countmin87, __u32, 327680);
BPF_ARRAY(countmin88, __u32, 327680);
...
#pragma unroll
    ...
    uint32_t hash86 = MurmurHash3_x86_32(&pkt, sizeof(pkt), 66);
    uint32_t hash87 = MurmurHash3_x86_32(&pkt, sizeof(pkt), 77);
    ...
    __u32 *val81 = countmin81.lookup(&target_idx81);
    if (val81)
        lock_xadd(val81, 1);

    __u32 *val82 = countmin82.lookup(&target_idx82);
    if (val82)
        lock_xadd(val82, 1);

    __u32 *val83 = countmin83.lookup(&target_idx83);
    if (val83)
        lock_xadd(val83, 1);
    __u32 *val84 = countmin84.lookup(&target_idx84);
    if (val84)
        lock_xadd(val84, 1);
    __u32 *val85 = countmin85.lookup(&target_idx85);
    if (val85)
        lock_xadd(val85, 1);
    __u32 *val86 = countmin86.lookup(&target_idx86);
    if (val86)
        lock_xadd(val86, 1);
    __u32 *val87 = countmin87.lookup(&target_idx87);
    if (val87)
        lock_xadd(val87, 1);
    __u32 *val88 = countmin88.lookup(&target_idx88);
    if (val88)
        lock_xadd(val88, 1);
    ...
    uint32_t hash76 = MurmurHash3_x86_32(&pkt, sizeof(pkt), 66);
    uint32_t hash77 = MurmurHash3_x86_32(&pkt, sizeof(pkt), 77);
    uint32_t hash78 = MurmurHash3_x86_32(&pkt, sizeof(pkt), 88);
    ...
    __u32 *val71 = countmin71.lookup(&target_idx71);
    if (val71)
        lock_xadd(val71, 1);

    __u32 *val72 = countmin72.lookup(&target_idx72);
    if (val72)
        lock_xadd(val72, 1);

    __u32 *val73 = countmin73.lookup(&target_idx73);
    if (val73)
        lock_xadd(val73, 1);
    __u32 *val74 = countmin74.lookup(&target_idx74);
    if (val74)
        lock_xadd(val74, 1);
    __u32 *val75 = countmin75.lookup(&target_idx75);
    if (val75)
        lock_xadd(val75, 1);
    __u32 *val76 = countmin76.lookup(&target_idx76);
    if (val76)
        lock_xadd(val76, 1);
    __u32 *val77 = countmin77.lookup(&target_idx77);
    if (val77)
        lock_xadd(val77, 1);
    __u32 *val78 = countmin78.lookup(&target_idx78);
    if (val78)
        lock_xadd(val78, 1);
