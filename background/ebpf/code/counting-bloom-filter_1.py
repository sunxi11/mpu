...
def get_cycles():
    ...
    for i in str_1:
        if i!='' and i[0]>='0' and i[0]<='9':
            num.append(int(i))
    outputfn="cycles/counting-bloom-filter_1.log"
...
if __name__ == '__main__':
    ...
    # load BPF program
    b = BPF(src_file=f"{sys.path[0]}/ebpf/new/bloomfilter/counting-bloom-filter_1.h", cflags=custom_cflags, device=None)
